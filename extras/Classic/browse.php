...
$gamename = preg_replace('#\W#', '-', $in['name']);
	if($seo_on == 1){
       ...
       echo '<a href=\''.$playlink.'\' title=\''.$in['name'].'\'>';
				      		if($in['type'] == 1){
				      		echo '<img src=\''.$domain.'/'.$thumbsfolder.'/'.$in['thumb'].'\' title=\''.$in['name'].'\' alt=\''.$in['name'].'\' width=\'80\' height=\'80\' border=\'0\' style=\'margin:3px\'>';
				      		}else{
				      		echo '<img src=\''.$in['thumburl'].'\' title=\''.$in['name'].'\' alt=\''.$in['name'].'\' width=\'80\' height=\'80\' border=\'0\' style=\'margin:3px\'>';
				      		}
				      		echo '</a>';
}
$count++;
