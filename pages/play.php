...
<table width=\'98%\' align=\'center\'>
	...
	<tr>
		<td class=\'header\' colspan=\'2\'><p>&nbsp;<p>'.$belowgames.'<p>Details</td>
	</tr>
	<tr>
...
echo '	<tr>
	...
	<tr>
		...
		echo '	<tr>
				<td width=\'30%\' class=\'content\' style=\'padding:4px;\' valign=\'top\'><b>Posted By:</b> '.$commenter.'</td>
				<td valig=\'top\' class=\'content\'>'.$row['comment'].'</td>
			</tr>
			<tr>
...
$db->query('UPDATE dd_users SET plays=plays+1 WHERE userid=\''.$usrdata['userid'].'\'');
