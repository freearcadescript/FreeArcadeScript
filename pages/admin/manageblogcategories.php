...
function categories(){
	...
	echo '	<tr>
			...
			<td><a href=\''.$domain.'/index.php?action=admin&case=manageblogcategories&cmd=edit&categoryid='.$ir['categoryid'].'\'><img src=\''.$domain.'/templates/'.$template.'/images/editbtn.png\' border=\'0\'></a>
