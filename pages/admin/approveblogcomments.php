...
function approve(){
	...
	echo '<tr>
			...
			<a href=\''.$domain.'/index.php?action=admin&case=approveblogcomments&cmd=do_approve&commentid='.$row['commentid'].'\'><img src=\''.$domain.'/templates/default/images/approve.png\' border=\'0\'></a>

<a href=\''.$domain.'/index.php?action=admin&case=approveblogcomments&cmd=delete&commentid='.$row['commentid'].'\'  onclick="return confirm(\'Are you sure you want to delete the comment?\')"><img src=\''.$domain.'/templates/default/images/deletebtn.png\' border=\'0\'></a>
