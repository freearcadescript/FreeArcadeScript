...
function links(){
	...
	echo '	<tr>
			...
			<td>
			<a href=\''.$domain.'/index.php?action=admin&case=managelinks&cmd=edit&ID='.$ir['ID'].'\'><img src=\''.$domain.'/templates/'.$template.'/images/editbtn.png\' border=\'0\'></a>
		
			<a href=\''.$domain.'/index.php?action=admin&case=managelinks&cmd=delete&ID='.$ir['ID'].'\'  onclick="return confirm(\'Are you sure you want to delete this link? \')"><img src=\''.$domain.'/templates/'.$template.'/images/deletebtn.png\' border=\'0\'></a>
