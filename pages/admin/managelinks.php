...
function links(){
	...
	echo '	<tr>
			...
			<a href=\''.$domain.'/index.php?action=admin&case=managelinks&cmd=delete&ID='.$ir['ID'].'\'  onclick="return confirm(\'Are you sure you want to delete this link? \')"><img src=\''.$domain.'/templates/default/images/deletebtn.png\' border=\'0\'></a>
