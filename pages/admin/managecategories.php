...
if(isset($_POST['submit'])){
	...
	mysql_query("UPDATE dd_categories SET name='$name', tags='$tags', metadescr='$metadescr', active='$active' WHERE ID='$ID' ");
}else{
...
<form action=\''.$domain.'/index.php?action=admin&case=managecategories&cmd=edit&ID='.$ID.'\' method=\'POST\'>
	...
	Active: <input type=\'text\' size=\'2\' name=\'active\' value=\''.$ir['active'].'\'><br>
