...
function categories(){
	...
	echo '	<tr>
			...
			<td><a href=\''.$domain.'/index.php?action=admin&case=managepagecategories&cmd=edit&categoryid='.$ir['categoryid'].'\'><img src=\''.$domain.'/templates/default/images/editbtn.png\' border=\'0\'></a>
