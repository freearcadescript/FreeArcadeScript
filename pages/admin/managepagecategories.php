...
function categories(){
	...
	echo '<tr>
			...
			<td><a href=\''.$domain.'/index.php?action=admin&case=managepagecategories&cmd=edit&categoryid='.$ir['categoryid'].'\'><img src="pages/admin/img/edit.png" width="24" height="24" alt="edit" title="Edit" /></a>
				<a href=\''.$domain.'/index.php?action=admin&case=managepagecategories&cmd=delete&categoryid='.$ir['categoryid'].'\'  onclick="return confirm(\'Are you sure you want to delete the category '.$ir['categoryname'].'? \n All entries in this category will be deleted from the database too.\')"><img src="pages/admin/img/delete.png" width="24" height="24" alt="delete" title="Delete" /></a></td>
		</tr>';
	}	
echo '</tbody>
</table>';
