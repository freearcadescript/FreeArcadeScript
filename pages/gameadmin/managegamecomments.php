...
function comments(){
	...
	echo '<tr>
			...
			<td><a href=\''.$domain.'/index.php?action=gameadmin&case=managegamecomments&cmd=edit&ID='.$ir['ID'].'\'><img src="pages/admin/img/edit.png" width="24" height="24" alt="edit" title="Edit" border="0" /></a>
				<a href=\''.$domain.'/index.php?action=gameadmin&case=managegamecomments&cmd=delete&ID='.$ir['ID'].'\'  onclick="return confirm(\'Are you sure you want to delete this comment?\')"><img src="pages/admin/img/delete.png" width="24" height="24" alt="delete" title="Delete" border="0" /></a></td>
		</tr>';
	}
echo '</tbody>
</table>';
...
<br clear="all">
<form action=\''.$domain.'/index.php?action=gameadmin&case=managegamecommentss&cmd=edit&ID='.$ID.'\' method=\'post\'>
	<table id="table">
		<thead>
			<tr>
