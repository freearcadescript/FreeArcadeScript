...
echo '<div class="header">
	...
	<div class="content">';
		...
		<a href=" '.$domain.'/rss-arcade.php" target="_blank"><img src="'.$domain.'/templates/'.$template.'/style/images/rss.png" alt="rss" border="0" /> RSS-Games</a><br />';
		if ($showblog == 1) { echo '<a href="'.$domain.'/rss-blog.php" target="_blank"><img src="'.$domain.'/templates/'.$template.'/style/images/rss.png" alt="rss" border="0" /> RSS-Blog</a><br />'; };	?>
