...
global $domain, $db, $seo_on, $usrdata, $entryid, $blogcommentsshown, $i, $blogfollowtags, $template;
...
global $domain, $db, $seo_on, $suserid, $entryid, $blogentriesshown, $usrdata, $commenterurl, $commenter, $blogcommentpermissions, $template;
