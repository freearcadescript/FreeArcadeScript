	      	...
	      	<td width=\'50%\' valign=\'top\'>
	      		...
	      		<table width=\'100%\' border=\'0\'>
	      			...
	      			<tr>
	      				...
	      				';
				      		if($in['type'] == 1){
				      		echo '	<img src=\''.$domain.'/'.$thumbsfolder.'/'.$in['thumb'].'\' width=\'120\' width=\'90\' border=\'0\'>';
				      		}else{
				      		echo '	<img src=\''.$in['thumburl'].'\' width=\'120\' width=\'90\' border=\'0\'>';
				      		}
...
for($i = 1; $i <= $totalpages; $i++){
	...
	if($seo_on == 1){
		echo '<a href=\''.$domain.'/mostplayed/page'.$i.'.html\'>'.$i.'</a> ';
	}else{
		echo '<a href=\''.$domain.'/index.php?action=mostplayed&page='.$i.'\'>'.$i.'</a> ';
	}
