...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&appId=228128144054691&version=v2.0";
  fjs.parentNode.insertBefore(js, fjs);
}(document, 'script', 'facebook-jssdk'));</script>
<table width="900" border="0" align="center" class="maintable" cellpadding="0" cellspacing="0">
	<tr>
		<td colspan="2">
		<img src="<?=$domain?>/templates/<?php echo $template ; ?>/images/banner.png" width="900" height="109"></img>
	...
	if (!empty($announcements)) {
		echo '			<table width="100%" align="center">
				...
				<tr>
					<td class="content">'.$announcements.'</td>
				</tr></table><br />';
	};
	?>
	...
	<tr>
		...
		<div align="center"><input type="submit" name="submit" value="Login">&nbsp;&nbsp;</div><br /><center>Need an account?<br /><a href="'.$domain.'/signup/">Sign up</a> now.</center>
		</form>
		</td>
		</tr>';
		}else{
		...
		<tr>
		<td class="content2">
		Hello, <b>'.$usrdata['username'].'</b> (<a href="'.$domain.'/myaccount/">Edit</a>)
		(<a href=\''.$domain.'/index.php?action=admin\'>Admin</a>)
		<br />
		<br />Enjoy the arcade, and have a great time!<br /><br /> Had enough of the arcade?
		Click <a href="'.$domain.'/logout/">here</a> to logout.<br />
...
<input type="text" name="keyword" style="width:70%" value="Search" /> <input class="button" type="submit" name="submit" value="Go" style="width:20%"/>
</div>
</td>
</tr>
</table>
...
?>
			<table width="100%" >
				...
				<?php include ('templates/retro/left/cats.php'); ?>
				</td>
				</tr>
