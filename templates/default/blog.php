...
$limits = ($show - 1) * $max; 
$r2 = "SELECT * FROM blogentries WHERE visible='1' order by entryid desc LIMIT ".$limits.",".$max ;

$sqltitle="blogmain-page".$show ;
$r1 = sqlcache($sqltitle, $cachelife, $r2);

$totalres = mysql_result($db->query('SELECT COUNT(entryid) AS total FROM blogentries where visible=\'1\' '),0);	
