...
function themes(){
	...
	while($row = $db->fetch_row($r)){
		...
		echo'<tr>
				...
				<td><a href="'.$domain.'/index.php?action=admin&case=themes&cmd=edit&ID='.$ID.'"><img src="panels/admin/img/edit.png" width="24" height="24" alt="edit" title="Edit" /></a>
					<a href="'.$domain.'/index.php?action=admin&case=themes&cmd=delete&ID='.$ID.'"  onclick="return confirm(\'Are you sure you want to delete the theme '.$name.'?\')"><img src="panels/admin/img/delete.png" width="24" height="24" alt="delete" title="Delete" /></a></td>
			</tr>'; }
echo'</tbody>
</table>';
