...
echo'<tbody>
	<tr>
		...
		<td><a href="'.$domain.'/index.php?action=admin&case=managemembers&cmd=edit&userid='.$userid.'"><img src="panels/admin/img/edit.png" width="24" height="24" alt="edit" title="Edit" /></a></td>
	</tr>
</tbody>';
}
