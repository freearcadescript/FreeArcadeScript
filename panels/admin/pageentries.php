      ...
      $category = $row['category'];
		echo'<tbody>
			<tr>
				...
				<td><a href=\''.$domain.'/index.php?action=admin&case=pageentries&cmd=editentry&entryid='.$entryid.'\' ><img src="panels/admin/img/edit.png" width="24" height="24" alt="edit" title="Edit" /></a>
				<a href=\''.$domain.'/index.php?action=admin&case=pageentries&cmd=deleteentry&entryid='.$entryid.'\' ><img src="panels/admin/img/delete.png" width="24" height="24" alt="delete" title="Delete" /></a></td>
			</tr>
		</tbody>'; }
echo '</table>';
