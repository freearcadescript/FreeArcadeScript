...
function categories(){
	...
	echo '<div class="heading">
			<h2>Manage Categories</h2>
                ...
                <br clear="all">
		<a href=\''.$domain.'/index.php?action='.$action.'&case=addblogcategory\' class="button">New Category</a>
		<table id="table">
			<thead>
				<tr>
					<th>ID</th>
	...
	echo '<tr>
			...
			<td><a href=\''.$domain.'/index.php?action='.$action.'&case=manageblogcategories&cmd=edit&categoryid='.$ir['categoryid'].'\'><img src="panels/admin/img/edit.png" width="24" height="24" alt="edit" title="Edit" /></a>
				<a href=\''.$domain.'/index.php?action='.$action.'&case=manageblogcategories&cmd=delete&categoryid='.$ir['categoryid'].'\'  onclick="return confirm(\'Are you sure you want to delete the category '.$ir['categoryname'].'? \n All etries in this category will be deleted from the database too.\')"><img src="panels/admin/img/delete.png" width="24" height="24" alt="delete" title="Delete" /></a></td>
		</tr>';
	}	
echo '</tbody>
</table>';
...
<br clear="all">
<form action=\''.$domain.'/index.php?action='.$action.'&case=manageblogcategories&cmd=edit&categoryid='.$categoryid.'\' method=\'post\'>
	<table id="table">
		<thead>
			<tr>
