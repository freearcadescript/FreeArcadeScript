...
$totalpages = ceil($totalres / $max);
	...
	echo '<tbody>
		<tr>
			...
			<td width="655px"><a href=\''.$domain.'/index.php?action='.$action.'&case=testgame&gameid='.$gameid.'\' target=\'_blank\'>'.$gamename.'</a></td>
			<td><a href=\''.$domain.'/index.php?action='.$action.'&case=managegames&cmd=edit&ID='.$gameid.'&type='.$type.'\'><img src="panels/admin/img/edit.png" width="24" height="24" alt="edit" title="Edit" /></a>
				...
				<a href=\''.$domain.'/index.php?action='.$action.'&case=reported&cmd=solved&ID='.$gameid.'\' ><img src="panels/admin/img/approve.png" width="24" height="24" alt="solved" title="Solved" /></a></td>
		</tr>
	</tbody>'; }
echo '</table>
<div class="page-box">'
